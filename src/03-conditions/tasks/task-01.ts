...
let graduationDecision: string;

if (finalScore >= 75 && attendance >= 90 && tuitionPaid) {
    graduationDecision = "Congratulations! You are eligible to graduate.";
} else {
    graduationDecision = "You are not eligible to graduate.";
}

console.log(graduationDecision);
